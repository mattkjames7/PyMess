...
def _GetMisfitFuncCts(v,C,dC,dOmega=1.15*np.pi,mass=1.67212e-27,ProtonEff=1.0,nSpec=1.0,Tau=0.095,g=8.31e-5):
	...
	def Func(X):
		...
		Cm = KappaDistCts(n,v,T,mass,K,ProtonEff,dOmega,nSpec,Tau,g)
...
def FitKappaDistCts(v,Counts,n0,T0,dOmega=1.15*np.pi,mass=1.67212e-27,ProtonEff=1.0,nSpec=1.0,Tau=0.095,g=8.31e-5):
